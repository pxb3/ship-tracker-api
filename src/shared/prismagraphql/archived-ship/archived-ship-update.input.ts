...
import { ArchivedShipStaticDataUpdateOneWithoutArchivedShipNestedInput } from '../archived-ship-static-data/archived-ship-static-data-update-one-without-archived-ship-nested.input';

@InputType()
export class ArchivedShipUpdateInput {
    ...
    @Field(() => ArchivedShipStaticDataUpdateOneWithoutArchivedShipNestedInput, {nullable:true})
    ArchivedShipStaticData?: ArchivedShipStaticDataUpdateOneWithoutArchivedShipNestedInput;
}
