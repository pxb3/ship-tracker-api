...
import { ArchivedShipUpdateOneRequiredWithoutArchivedShipStaticDataNestedInput } from '../archived-ship/archived-ship-update-one-required-without-archived-ship-static-data-nested.input';

@InputType()
export class ArchivedShipStaticDataUpdateInput {
    ...
    @Field(() => ArchivedShipUpdateOneRequiredWithoutArchivedShipStaticDataNestedInput, {nullable:true})
    archivedShip?: ArchivedShipUpdateOneRequiredWithoutArchivedShipStaticDataNestedInput;
}
