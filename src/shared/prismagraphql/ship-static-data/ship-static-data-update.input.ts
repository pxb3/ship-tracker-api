...
import { ShipUpdateOneRequiredWithoutShipStaticDataNestedInput } from '../ship/ship-update-one-required-without-ship-static-data-nested.input';

@InputType()
export class ShipStaticDataUpdateInput {
    ...
    @Field(() => ShipUpdateOneRequiredWithoutShipStaticDataNestedInput, {nullable:true})
    ship?: ShipUpdateOneRequiredWithoutShipStaticDataNestedInput;
}
