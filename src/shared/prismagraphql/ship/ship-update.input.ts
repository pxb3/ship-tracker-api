...
import { ShipStaticDataUpdateOneWithoutShipNestedInput } from '../ship-static-data/ship-static-data-update-one-without-ship-nested.input';
...
export class ShipUpdateInput {
    ...
    @Field(() => ShipStaticDataUpdateOneWithoutShipNestedInput, {nullable:true})
    ShipStaticData?: ShipStaticDataUpdateOneWithoutShipNestedInput;
}
