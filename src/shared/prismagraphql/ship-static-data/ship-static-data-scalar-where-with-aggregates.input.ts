...
@InputType()
export class ShipStaticDataScalarWhereWithAggregatesInput {

    @Field(() => [ShipStaticDataScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<ShipStaticDataScalarWhereWithAggregatesInput>;

    @Field(() => [ShipStaticDataScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<ShipStaticDataScalarWhereWithAggregatesInput>;

    @Field(() => [ShipStaticDataScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<ShipStaticDataScalarWhereWithAggregatesInput>;

    @Field(() => StringWithAggregatesFilter, {nullable:true})
    id?: StringWithAggregatesFilter;

    @Field(() => StringWithAggregatesFilter, {nullable:true})
    shipId?: StringWithAggregatesFilter;
