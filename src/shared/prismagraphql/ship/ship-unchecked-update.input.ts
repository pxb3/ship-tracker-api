...
import { ShipStaticDataUncheckedUpdateOneWithoutShipNestedInput } from '../ship-static-data/ship-static-data-unchecked-update-one-without-ship-nested.input';

@InputType()
export class ShipUncheckedUpdateInput {
    ...
    @Field(() => ShipStaticDataUncheckedUpdateOneWithoutShipNestedInput, {nullable:true})
    ShipStaticData?: ShipStaticDataUncheckedUpdateOneWithoutShipNestedInput;
}
