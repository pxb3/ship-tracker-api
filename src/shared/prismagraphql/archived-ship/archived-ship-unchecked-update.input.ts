...
import { ArchivedShipStaticDataUncheckedUpdateOneWithoutArchivedShipNestedInput } from '../archived-ship-static-data/archived-ship-static-data-unchecked-update-one-without-archived-ship-nested.input';

@InputType()
export class ArchivedShipUncheckedUpdateInput {
    ...
    @Field(() => ArchivedShipStaticDataUncheckedUpdateOneWithoutArchivedShipNestedInput, {nullable:true})
    ArchivedShipStaticData?: ArchivedShipStaticDataUncheckedUpdateOneWithoutArchivedShipNestedInput;
}
