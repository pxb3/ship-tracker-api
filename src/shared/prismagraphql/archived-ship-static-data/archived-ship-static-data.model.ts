...
import { ArchivedShip } from '../archived-ship/archived-ship.model';

@ObjectType()
export class ArchivedShipStaticData {
    ...
    @Field(() => ArchivedShip, {nullable:false})
    archivedShip?: ArchivedShip;
}
